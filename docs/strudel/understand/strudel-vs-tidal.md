...
While Strudel also has a way of [communicating with Superdirt](https://strudel.cc/learn/input-output/),
...
You can find a [list of available effects here](https://strudel.cc/learn/effects/).

### Sampler

Strudel’s sampler supports [a subset](https://strudel.cc/learn/samples/) of Superdirt’s sampler.
