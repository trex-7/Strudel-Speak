...
If you are just getting started with Strudel, you can learn the basics of the Mini-Notation in a more practical manner in the [workshop](https://strudel.cc/workshop/first-sounds/).
...
Next: How do [Samples](https://strudel.cc/learn/samples/) play into this?